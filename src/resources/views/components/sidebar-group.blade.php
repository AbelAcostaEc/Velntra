...
<div x-data="{ open: @js($open) }">
    <button type="button" title="{{ $label }}" x-on:click="open = ! open" class="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-primary-600 transition hover:bg-primary-100 hover:text-primary-950">
